...
| 2026-04-27 | integrations | [`integrations/20260427-001-harbor-image-path-branch-coupling.md`](./integrations/20260427-001-harbor-image-path-branch-coupling.md) | CI 把分支名拼進 Harbor image path 的隱性風險；分支改名會讓 Helm 拉到 stale image；CI 必須加事後 tag 驗證 step；Helm pending-upgrade 解卡流程 |
