...
1. **案子規模**：簡易看板，CRUD + 拖拉，輕量。
2. **使用者量級**：個人使用，無高併發需求。
3. **目前團隊對於此技術的熟悉度**
4. **3 年成長性**：目前少量使用者夠用，未來若擴成多人協作，Next.js 全端 + PG 仍可水平延伸，複雜運算可以搭配Nest Js 或c# 。
...
### 4.2 用 Chrome DevTools MCP 從影片抽影格來更新 PRD 及 ui節
...
過程我會Review 這個計畫的合理性，並不斷和AI 討論，最後請AI在執行時，如果 Plan 評估出某些工作太大，AI 會主動把它拆成多個 Spec。
