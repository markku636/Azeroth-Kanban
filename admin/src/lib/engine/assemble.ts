 ...
 */
// 縮圖 A/B 變體配方移至純模組 thumb-variants.ts（client 可 import）；此處 re-export 維持既有匯入路徑。
export { THUMBNAIL_VARIANTS, type ThumbTitlePos } from './thumb-variants';
import type { ThumbTitlePos } from './thumb-variants';
