...
export const STYLE_PRESETS: StylePreset[] = [
  ...
  { label: '迷因吐槽', comedy: true, hint: '改編成迷因吐槽搞笑風格：情緒誇張、用 setup→反轉的爆點結構、多放大字幕（caption 鋪陳、punchline 吐槽）；反轉鏡設 punch=true，並配卡點音效 sfx（vineboom／rimshot／scratch／ding／whoosh／boing 擇一）。' },
