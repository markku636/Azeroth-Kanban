...
export interface StylePreset { label: string; hint: string }

export const STYLE_PRESETS: StylePreset[] = [
  { label: '好笑有趣', hint: '改編成「好笑、有趣、娛樂性高」的版本：放大反差與意外轉折、用生活化的吐槽與誇張反應製造笑點，節奏輕快、每一鏡都想讓人笑或想看下一鏡；就算來源本身很正經，也要找到能玩的哏把它變好看。' },
