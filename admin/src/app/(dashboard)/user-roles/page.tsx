    ...
    <div className="p-6">
      <div className="max-w-7xl">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-500">指派使用者的系統角色</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-0 p-8 text-center shadow dark:bg-gray-100">
            <PiUserGearDuotone className="mx-auto h-12 w-12 text-gray-300" />
                    ...
                    <tr key={user.id} className="transition-colors hover:bg-gray-50">
                      ...
                      <td className="whitespace-nowrap px-6 py-4 text-right">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium text-blue-600 transition-colors hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-blue-900/20"
                        >
                          <PiUserGearDuotone className="h-4 w-4" />
                          指派角色
                        </button>
                      </td>
                    </tr>
        ...
        {editUser && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50">
            <div className="flex max-h-[85vh] w-full max-w-lg flex-col rounded-lg bg-gray-0 shadow-xl dark:bg-gray-100">
              ...
              <div className="flex-1 overflow-y-auto px-6 py-4">
                {rolesLoading ? (
                  ...
                  <div className="space-y-1">
                    <label className="flex cursor-pointer items-center gap-3 rounded-lg px-3 py-3 transition-colors hover:bg-gray-50">
                      <input
                        type="radio"
                        name="role-select"
                      ...
                      <span className="shrink-0">
                        {selectedRole === null ? (
                          <PiRadioButtonBold className="h-5 w-5 text-blue-600 dark:text-blue-400" />
                        ) : (
                          <PiCircleDuotone className="h-5 w-5 text-gray-400" />
                        )}
                      </span>
                    ...
                    {allRoles.map((role) => {
                      ...
                      return (
                        <label
                          key={role.id}
                          className="flex cursor-pointer items-center gap-3 rounded-lg px-3 py-3 transition-colors hover:bg-gray-50"
                        >
                          <input
                            type="radio"
                            name="role-select"
